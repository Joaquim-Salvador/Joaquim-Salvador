 ...
 Estudante de **Engenharia de Software pela Univille**  
 Técnico em **Desenvolvimento de Sistemas pelo SENAI**

 Desenvolvedor focado em **back-end, APIs e automações**, com experiência prática na construção de projetos reais.

 Buscando sempre evoluir tecnicamente e criar soluções **eficientes, escaláveis e com impacto real**.
